...
<head>
	...
	<title>Apotek Rafifah Admin</title>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategory" class="form-control">
                            ...
                            <option>Obat resep dokter</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="khasiat[]" value="panas" <?php in_array('panas', $checkked) ? print "checked" : ""; ?>> Panas/demam <br>
